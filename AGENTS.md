...
**Stage: implementation, Phase 5 of nine.** Build steps 1–6 are done and step 7 onward is
in progress; `ARCHITECTURE.md` PART 14 is the phase plan and `README.md`'s status table is
the current state. Two handoff documents carry it: **[`HANDOFF.md`](./HANDOFF.md)** for the
work order and the facts reconciled from the real source files, and
**[`HANDOFF-PHASE5.md`](./HANDOFF-PHASE5.md)** for the phase in flight — what is done, what
is left, and the traps in it. Read whichever covers your task; neither replaces this file.
...
2. **[`DECISIONS.md`](./DECISIONS.md)** — resolutions R-1 … R-12. Binding.
